...
#ifndef JUCER_CUSTOMLOOKANDFEEL_H_INCLUDED
#define JUCER_CUSTOMLOOKANDFEEL_H_INCLUDED
...
public:
    CustomLookAndFeel()
    {
        ...
        setColour(0x1005008, /*MidiKeyboardComponent::shadowColourId*/ Colours::lightgrey);
...
#endif   // __CUSTOMLOOKANDFEEL_JUCEHEADER__
